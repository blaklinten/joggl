...
/**
 * This class holds the result of adding the duration of several entries.
 * It is a convenient way of presenting the relevant data to the next layer.
 * The entries has been chosen with respect to one property they have in common,
 * for instance Entry.Property.CLIENT if the entries belong to the same client.
 * */
public class AccumulatedTime {
	...
	/**
 	 * This method returns the common property (ID)
 	 * that the entries used to accumulate this duration share.
	...
	/**
 	 * This method returns the value of the common property (ID)
 	 * that the entries used to accumulate this duration share.
	...
	/**
 	 * This constructor creates a valid accumulated time from a common
 	 * property, its actual value and a total duration.
