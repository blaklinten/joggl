 ...
 * the entry that is currently running on the timer.
 * */
public class TimerStatus{
	...
	/**
 	 * This constructor will create a Timerstatus from a currently running
 	 * entry by extracting the necessary information and calculating 
